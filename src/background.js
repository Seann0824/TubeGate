importScripts(
  'shared/core.js', 'core/content.js', 'core/decision.js',
  'providers/jev-protocol.js', 'providers/jev.js',
  'services/request-queue.js', 'services/classification.js'
);
...
(function () {
  ...
  const classifier = new globalThis.TubeGateJevClassifier();
  const classification = globalThis.TubeGateClassification.createClassificationService({ runtime, classifier, writeStats });
